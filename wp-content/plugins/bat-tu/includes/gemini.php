...
class Battu_Gemini {
    ...
    public function ftn_battu_gemini_generate($prompt) {

        $settings = $this->settings();
        $gemini_keys  = $settings->geminiKeysArray();
        $gemini_model = $settings->geminiModel();
        $gemini_model = apply_filters('battu_gemini_model', $gemini_model);
        $result = null;
