...
class Battu_Mistral {
    ...
    private ?Battu_Settings $settings = null;
    ...
    private function settings(): Battu_Settings {
        if ($this->settings === null) {
            $this->settings = Battu_Settings::get_instance();
        }
    ...
    public function ftn_battu_mistral_generate(string $prompt): string {
