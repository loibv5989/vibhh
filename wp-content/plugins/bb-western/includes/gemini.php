...
class BBW_Gemini {
    ...
    public function ftn_gemini_generate($prompt) {
        ...
        $setiings = $this->setiings();
        $gemini_keys  = $setiings->geminiKeysArray();
        $gemini_model = $setiings->geminiModel();
        $gemini_model = apply_filters('fortune_gemini_model', $gemini_model);
        $result = null;
