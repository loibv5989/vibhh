...
class BbZodiac_Admin {
    ...
    public function renderSettingsPage(): void {
        ...
        <div class="wrap">
            ...
            <form method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                ...
                                Bật chức năng AI (Phân tích cung hoàng đạo)
                            </label>
                ...
                <table class="form-table">
                    <tr>
                        <th scope="row">Provider chính</th>
                        <td>
                ...
                <table class="form-table">
                    <tr>
                        <th scope="row">Tạo trang Cung Hoàng Đạo</th>
                        <td>
                            <button type="button" id="bb-zodiac-create-pages" class="button button-primary">Tạo trang</button>
                            <div id="bb-zodiac-create-pages-results" style="margin-top:10px;"></div>
                            <p class="description">
                                Tạo trang với shortcode <code>[zodiac_form]</code>:<br>
                                • <strong>/cung-hoang-dao/</strong> — Giải mã cung hoàng đạo online<br>
    ...
    public function createPages(): void {
        ...
        $pages_config = [
            [
                'title'   => 'Giải Mã Cung Hoàng Đạo Online – 12 Cung Chiêm Tinh',
                'content' => "<!-- wp:shortcode -->\n[zodiac_form]\n<!-- /wp:shortcode -->",
                'slug'    => 'cung-hoang-dao',
                'parent'  => 0,
            ],
            [
                'title'   => 'Bói Tính Cách Theo Cung Hoàng Đạo',
                'content' => "<!-- wp:shortcode -->\n[zodiac_tinh_cach]\n<!-- /wp:shortcode -->",
                'slug'    => 'tinh-cach',
                'parent'  => 'cung-hoang-dao',
            ],
            [
                'title'   => 'Bói Tình Yêu – Hợp Khắc Cung Hoàng Đạo',
                'content' => "<!-- wp:shortcode -->\n[zodiac_tinh_yeu]\n<!-- /wp:shortcode -->",
                'slug'    => 'tinh-yeu',
                'parent'  => 'cung-hoang-dao',
            ],
            [
                'title'   => 'Tử Vi Hàng Ngày Theo Cung Hoàng Đạo',
                'content' => "<!-- wp:shortcode -->\n[zodiac_tu_vi]\n<!-- /wp:shortcode -->",
                'slug'    => 'tu-vi',
                'parent'  => 'cung-hoang-dao',
            ],
            [
                'title'   => 'Bản Đồ Sao Cá Nhân – Natal Chart',
                'content' => "<!-- wp:shortcode -->\n[zodiac_ban_do_sao]\n<!-- /wp:shortcode -->",
                'slug'    => 'ban-do-sao',
                'parent'  => 'cung-hoang-dao',
            ]
