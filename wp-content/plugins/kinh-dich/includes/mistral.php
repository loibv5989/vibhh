...
class IChing_Mistral {

    private static ?self $instance = null;
    private ?IChing_AI_Settings $helpers = null;
    ...
    private function helpers(): IChing_AI_Settings {
        if ($this->helpers === null) {
            $this->helpers = IChing_AI_Settings::get_instance();
        }
        return $this->helpers;
    }
