...
class TshLove_Admin {
    ...
    public function renderSettingsPage(): void {
        ...
        ?>
        <div class="wrap">
            <h1>Settings | Love Compatibility - Numerology</h1>
            <form method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description" style="color: #d63638;">
                                <strong>⚠️ Note:</strong> If disabled, all AI features will be turned off.
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <table class="form-table">
                    <tr>
                        <th scope="row">
                            ...
                            <p style="font-weight: normal; color: #666; margin: 5px 0 0 0;">Love Compatibility analysis</p>
                        </th>
                        <td>
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">Enter multiple keys for automatic rotation when rate limited.</p>
                        </td>
                    </tr>
                </table>
                ...
                <h2>📄 Create Pages</h2>
                <p>Automatically create a WordPress page with shortcode <code>[tsh_love_form]</code>.</p>
                <button type="button" id="bty-tsh-create-pages" class="button button-secondary">Create Sample Page</button>
    ...
    public function createPages(): void {
        ...
        $pages   = [
            [
                    'title' => 'Love Compatibility - Numerology',
