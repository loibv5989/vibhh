...
class TshLove_Gemini {
    ...
    private function sendAdminNotification($subject, $message) {
        ...
        $subject = '[Love Compatibility] ' . $subject;
    ...
    private function helpers() {
        ...
        if ($this->helpers === null) {
            $this->helpers = TshLove_Helpers::get_instance();
        }
    ...
    public function ftn_gemini_generate($prompt) {
        ...
        $gemini_model = apply_filters('bty_tsh_gemini_model', $gemini_model);
        $result = null;
