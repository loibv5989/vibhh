            ...
            <div class="nrgy-calc-card">
                <form id="nrgy-form" novalidate>
                    <div class="nrgy-form-row">
                        ...
                        <div class="nrgy-form-group">
                            <label for="nrgy-dob">Date of Birth <span style="font-weight:400;opacity:.7">(MM/DD/YYYY)</span></label>
                            <input type="text" id="nrgy-dob" class="nrgy-input" placeholder="e.g. 09/11/1996" maxlength="10">
