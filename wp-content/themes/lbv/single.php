        ...
        <div class="content-wrapper">
            ...
            <main id="primary" class="content-area">
                ...
                while ( have_posts() ) : the_post();
                    ...
                    $editing = isset($_GET['edit-artist']) && $_GET['edit-artist'] == '1';
                    $edit_url = add_query_arg('edit-artist', '1', get_permalink($post_id));
                    ?>
                            ...
                            <?php if ( 'post' === $current_post_type ) : ?>
                                <div class="entry-meta">
                                    ...
                                    <?php if ( ! $editing ) : ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else : ?>
                                        <span class="lbv-edit-exit-btn">
                                            <a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>">
                                                <?php esc_html_e( '⇱ Exit', 'lbv' ); ?>
                                            </a>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            <?php else:?>
                                <?php  if (!$editing) :?>
                                    <div class="entry-meta">
                                        <?php if (is_user_logged_in()) : ?>
                                            <span class="lbv-edit-artist-btn">
                                                <a href="<?php echo esc_url($edit_url); ?>"><?php _e( '📝Edit', 'lbv' ); ?></a>
                                            </span>
                                        <?php else : ?>
                                            <span class="lbv-edit-artist-btn"><?php _e( '📝Edit', 'lbv' ); ?></span>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
                                    <div class="entry-meta">
                                        <span class="lbv-edit-exit-btn">
                                            <a href="<?php echo esc_url(get_permalink($post_id)); ?>"><?php _e( '⇱ Exit', 'lbv' ); ?></a>
                                        </span>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
